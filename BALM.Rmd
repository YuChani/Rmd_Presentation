...
## Introduction
.nt-02.pull-left[
![:scale 100%](fig/BALM/fig1_BA_comparison.png)
]
.nt-02.pull-right[
![:scale 100%](fig/BALM/fig3_feature.png)
]
.f-90[
...
- **Sparse LiDAR**에선 point-to-point BA보다, point-to-plane/line BA 적용
]
---
## System Framework
.nt-02.f-90[
...
- **Odometry** : 새로운 scan의 rough pose 구함(Local BA전 pose)
  
- **Global transform** : rough pose를 통해서 feature point을 Global frame으로 변환
  
- **Adaptive Voxelization** : 각 Edge Voxel map/Planar Voxel map에 넣고 Adative Voxelization 수행
  
- **Local BA** : 각 Voxel의 mean/covariance를 통해 eigenvalue 기반 cost로 local BA 수행
  
- **Update/Marginalize** : pose와 Voxel 업데이트, 오래된 점은 marginalize
]
---
## BA Formulation
.nt-02.f-90[
...
## Adaptive Voxelization
.nt-02.pull-left[
![:scale 100%](fig/BALM/fig4_voxelmap.png)
]
...
## LOAM with Local BA
.nt-02.pull-left-50[
![:scale 100%](fig/BALM/fig5_overview.png)
]
...
.nt-02.pull-left-50[
![:scale 85%](fig/BALM/fig6_Horizon.png)
]
.nt-02.pull-right-50[
  ![:scale 85%](fig/BALM/table1_Horizon_Terror.png)
]
---
## Experimental
.nt-02.f-90[
...
.center[
![:scale 45%](fig/BALM/fig7_Mid40.png)
]
---
## Experimental
.nt-02.f-90[
...
.nt-02.pull-left-50[
![:scale 85%](fig/BALM/fig8_odometry_result.png)
]
.nt-02.pull-right-50[
  ![:scale 100%](fig/BALM/table2_Velodyn_Terror.png)
]
---
## Experimental
.center[
![:scale 70%](fig/BALM/fig9_map_alignment.png)
]
