...
$$\begin{align*}
\frac{\partial \mathbf{u}_k}{\partial \mathbf{p}_j} &= \left[ \frac{\partial U \mathbf{e}_k}{\partial x_j} \quad \frac{\partial U \mathbf{e}_k}{\partial y_j} \quad \frac{\partial U \mathbf{e}_k}{\partial z_j} \right] \\
&= \left[ UC^{x_j} \mathbf{e}_k \quad UC^{y_j} \mathbf{e}_k \quad UC^{z_j} \mathbf{e}_k \right] \\
&= U \left[ C^{x_j} \mathbf{e}_k \quad C^{y_j} \mathbf{e}_k \quad C^{z_j} \mathbf{e}_k \right] \\
&= U \begin{bmatrix}
C^{x_j}_{1,k} & C^{y_j}_{1,k} & C^{z_j}_{1,k} \\
C^{x_j}_{2,k} & C^{y_j}_{2,k} & C^{z_j}_{2,k} \\
C^{x_j}_{3,k} & C^{y_j}_{3,k} & C^{z_j}_{3,k}
\end{bmatrix}
\end{align*}$$
]
---
